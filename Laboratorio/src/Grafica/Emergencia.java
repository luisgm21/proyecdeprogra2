...
public class Emergencia extends javax.swing.JDialog {
    ...
    private GestorCuadrilla quad;
    private GestorPersona persona;
    private GestorSolicitud soli;
    private Frame principal1;
    Calendar fechaActual = GregorianCalendar.getInstance();
    
    public Emergencia(java.awt.Frame parent, boolean modal,GestorPersona persona, GestorCuadrilla quad, GestorSolicitud soli) {
        super(parent, modal);
        initComponents();
        this.quad=quad;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos de la emergencia", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        jButton1.setText("elegir cuadrilla");
        ...
        jButton4.setText("Seleccionar receptor");
        ...
        jLabel7.setText("Nombre del receptor:");

        jButton5.setText("elegir afiliado");
        ...
        jLabel1.setText("Fecha ultimo pago:");

        jButton6.setText("Verficar pago");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ElegirCuadrilla lista= new ElegirCuadrilla(principal1,true,this.jTextField3,quad,emergencia);
        lista.setVisible(true);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ElegirAdministrativos lista= new ElegirAdministrativos(principal1,true,this.jTextField5,persona,emergencia);
        lista.setVisible(true);
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        AfiliadoEmergencia lista= new AfiliadoEmergencia(principal1,true,this.jTextField2,persona,emergencia,jDateChooser1);
        lista.setVisible(true);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        switch (emergencia.getPaciente().getFechaultpago().compareTo(fechaActual)){ 
            case 1: 
                JOptionPane.showMessageDialog(rootPane, "Pagos en orden");   
