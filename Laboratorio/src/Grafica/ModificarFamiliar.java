...
public class ModificarFamiliar extends javax.swing.JDialog {
    private Afiliado afiliado;
    private Persona familiar;
    public ModificarFamiliar(java.awt.Frame parent, boolean modal,Afiliado afiliado,Persona familiar) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(parent);
        this.afiliado=afiliado;
        this.familiar=familiar;
        text_nombre.setText(familiar.getNombre());
        text_DNI.setText(familiar.getDni());
        text_telefono.setText(familiar.getTelefono());
        text_direccion.setText(familiar.getDireccion());
        text_edad.setText(Integer.toString(familiar.getEdad()));
        grupo1.add(btn_si);
        grupo1.add(btn_no); 
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Modificar Familiar:");
