...
public class AltaAmbulancia extends javax.swing.JDialog {
    ...
    public void validar(){
        if(this.jTextField2.getText().isEmpty() || this.jTextField2.getText().isEmpty() ||this.jTextField3.getText().isEmpty() || this.jTextField4.getText().isEmpty()){
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "DATOS AMBULANCIA", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 12))); // NOI18N
