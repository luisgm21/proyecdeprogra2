...
public class Diagnostico extends javax.swing.JDialog {
    ...
    public Diagnostico(java.awt.Frame parent, boolean modal,GestorCuadrilla cuad,GestorSolicitud soli ) {
        super(parent, modal);
        initComponents();
    ...
    public void validar(){
        if(this.jTextField1.getText().isEmpty() || this.jTextField2.getText().isEmpty() ||this.jTextArea1.getText().isEmpty()){
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "DIAGNOSTICO", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 16))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        SeleccionarSolicitud lista = new SeleccionarSolicitud(principal1,true,this.jTextField1,jTextField2,soli,solicitud);
