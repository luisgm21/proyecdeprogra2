...
public class ListaEmpleados extends javax.swing.JDialog {
    ...
    private ArrayList<Empleado>listaauxiliar=new ArrayList();
    JTextField jTextField6;
    
    public ListaEmpleados(java.awt.Frame parent, boolean modal,JTextField jTextField6,GestorPersona gestor) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jList1.setModel(new javax.swing.AbstractListModel<Empleado>() {
            Empleado[] strings = {};
            public int getSize() { return strings.length; }
            public Empleado getElementAt(int i) { return strings[i]; }
        });
    ...
    private void btnaceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaceptarActionPerformed
        Empleado s = jList1.getSelectedValue();
        if (s!=null){
